...
const data = {
  ducks: [
    ...
    },
    {
      ...
      name: 'Zebra Duck',
      description:
        'This skittish beauty has been sighted in central Africa. Cryptoduckologists assert that the best time to see one of these magnificent quackers when the full moon is at its highest point on a windless night.',
      img: zebra,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      name: 'UFO Duck',
      description:
        "Many have had encountered this duck. We do not know why they continue to visit us. Perhaps they are peaceful observers, or perhaps they have more sinister intentions. It's possible we will never know.",
      img: ufo,
    },
  ],
};
